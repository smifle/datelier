...
$site_top = "https://datelier.tokyo";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@datelier.tokyo";
// $to = "master@smifle.net";
...
$Referer_check_domain = "datelier.tokyo";
...
$refrom_name = "ダトリエ一級建築士事務所";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "［ダトリエ一級建築士事務所］ お問い合わせありがとうございました。";
...
$remail_text = <<< TEXT
------------------------------------------------------------------------
このメッセージはダトリエ一級建築士事務所へ
お問い合わせをいただいた方へ自動送信されています。
お心当たりのない場合は、お手数ですが
info@datelier.tokyo までご連絡ください。
------------------------------------------------------------------------
...
──────────────────────
合同会社 ダトリエ一級建築士事務所
150-0001 東京都渋谷区神宮前3-38-16 ヴィラ外苑4-A　
T 03-6434-9683 / F 03-6434-9684
info@datelier.tokyo
https://datelier.tokyo/
──────────────────────
...
<header id="header">
	<h1 class="logo_datelier"><a href="#wrapper"><img src="img/header_logo_datelier.svg" alt="ダトリエ一級建築士事務所 [d&quot;atelier]"></a></h1>
</header>
<!-- /#header -->
<?php if($empty_flag == 1){ ?>
	<p class="lead">入力にエラーがあります。下記をご確認の上、修正をお願いいたします。</p>
	<div class="err_msg"><?php echo $errm; ?></div>
	<p class="btnBack"><input type="button" value="前画面に戻る" onClick="history.back()"></p>
<?php }else{ ?>
	<p class="lead">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p>
	<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
		...
		<p class="btnSubmit"><input type="submit" value="送信する"></p>
		<p class="btnBack"><input type="button" value="前画面に戻る" onClick="history.back()"></p>
	</form>
<?php } ?>
<footer id="footer"><p class="copyright">©2015 ダトリエ一級建築士事務所</p></footer>
</div>
</body>
</html>
...
<?php if($empty_flag == 1){ ?>
	...
	<p class="btnBack"><input type="button" value="前画面に戻る" onClick="history.back()"></p>
<?php }else{ ?>
	<p class="lead">お問い合わせ内容を送信いたしました。ありがとうございました。</p>
	<div class="err_msg"><?php echo $errm; ?></div>
	<p class="btnFinish"><a href="https://datelier.tokyo/" class="btn">トップページへ</a></p>
<?php } ?>
<footer id="footer"><p class="copyright">©2015 ダトリエ一級建築士事務所</p></footer>
</div>
</body>
...
function confirmOutput($arr){
	...
	foreach($arr as $key => $val) {
		...
		$html .= '<div class="confirm_item">'.$out;
...
function copyright(){
	echo '<footer id="footer"><p class="copyright">©2015 ダトリエ一級建築士事務所</p></footer>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
